...
int main() {
    ...
    if (scale == 'C' || scale == 'c') {
        convertedTemp = celsiusToFahrenheit(temperature); // Call celsiusToFahrenheit with temperature argument
        cout << "Converted temperature: " << convertedTemp << " F" << endl;
    } else if (scale == 'F' || scale == 'f') {
        convertedTemp = fahrenheitToCelsius(temperature); // Call fahrenheitToCelsius with temperature argument
        cout << "Converted temperature: " << convertedTemp << " C" << endl; // Correct the output operator from < to <<
    } else {
